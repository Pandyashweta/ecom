  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#420D09] flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Info Grid: Careers, Press, Sustainability */}
        <section className="py-24 px-4 md:px-8 bg-white text-[#420D09]">
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
                <div className="space-y-4">
                    <h3 className="text-2xl font-display border-b border-[#420D09] pb-2">Careers</h3>
                    <p className="text-stone-600 leading-relaxed">
                        ĀraHouse welcomes individuals passionate about design, craftsmanship, heritage storytelling, sustainability, and innovation.
                    </p>
                </div>
                <div className="space-y-4">
                    <h3 className="text-2xl font-display border-b border-[#420D09] pb-2">Press</h3>
                    <p className="text-stone-600 leading-relaxed">
                        For media inquiries, interviews, and brand stories, please contact our Communications Team.
                    </p>
                </div>
                <div className="space-y-4">
                    <h3 className="text-2xl font-display border-b border-[#420D09] pb-2">Sustainability</h3>
                    <p className="text-stone-600 leading-relaxed">
                        We are committed to small-batch production, reduced waste, responsible sourcing, and long-lasting design.
                    </p>
                </div>
            </div>
        </section>
