...
const Studio = () => {
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-foreground flex flex-col">
      <Header />
      <main className="flex-1">
            ...
            <div className="grid md:grid-cols-12 gap-8 items-center">
                <div className="md:col-span-7 relative z-10">
                    <div className="aspect-[4/5] rounded-lg overflow-hidden shadow-2xl">
                         <img src="https://images.unsplash.com/photo-1583391733952-3c339781488f?w=800&q=80" alt="Ruhé Studios" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                    </div>
                </div>
        ...
        <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto">
            <div className="grid md:grid-cols-12 gap-8 items-center">
                ...
                <div className="md:col-span-7 md:order-2 relative z-10">
                    <div className="aspect-[4/5] rounded-lg overflow-hidden shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800&q=80" alt="Kritá Studios" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="py-24 px-4 md:px-8 bg-[#420D09] text-[#F5E6D3] text-center">
            <div className="max-w-3xl mx-auto space-y-8">
                <h2 className="text-4xl md:text-5xl font-display">Featured Collections</h2>
                <p className="text-xl text-[#F5E6D3]/80 leading-relaxed font-light">
                ...
                <div className="pt-8">
                    <Link to="/new-arrivals" className="inline-block">
                        <button className="px-10 py-4 bg-stone-200 text-[#420D09] font-medium rounded hover:bg-stone-100 transition-all hover:px-12 duration-300">
                            Shop New Arrivals
                        </button>
                    </Link>
                </div>
